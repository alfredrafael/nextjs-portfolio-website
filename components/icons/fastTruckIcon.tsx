export default function FastTruckIcon({
  className,
  width = 38,
  height = 38,
}: {
  ...
  return (
    <>
      ...
      >
        ...
        <path
          d="M31.8,17.4l-4-5C27.6,12.1,27.3,12,27,12h-5V9c0-0.6-0.4-1-1-1H5C4.4,8,4,8.4,4,9v1h1c0.6,0,1,0.4,1,1s-0.4,1-1,1H4H3
